...
date: 2026-04-13 23:33:14.494702
authors:
  - bendu
label: matlab-for-statisticians
license: CC-BY-4.0
tags:
  - Statistics
  - programming
...
1. `randsample` generates a random sample
...
1. `tabular` counts the frequency of observations.

1. `iqr` calculates the interquartile range of given data.
