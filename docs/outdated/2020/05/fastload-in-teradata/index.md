...
date: 2026-04-13 23:15:31.255447
authors:
  - bendu
label: fastload-in-teradata
license: CC-BY-4.0
tags:
  - computer science
  - SQL
...
1. **Use temporary tables when you use `fastload` to load data**,
   as the tables involved might get blocked if issues happen in the middle.

1. Make sure to set a large enough CHECKPOINT for good performance.
