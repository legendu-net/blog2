...
date: 2026-04-15 19:27:00.455866
authors:
  - bendu
...
1. Samba is fast, secure and cross-platform.
   it is good for general purpose sharing and popular in companies.

1. SSHFS is slow but very secure and it is for Unix/Linux only.
...
1. There are some other file-copying tools such as `mbuffer` and `netcat`/`nc`
