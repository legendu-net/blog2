...
created: 2014-07-16 19:47:59
date: 2026-04-13 23:33:08.019671
authors:
  - bendu
label: stick-breaking-problems
license: CC-BY-4.0
tags:
  - fun problems
  - stick breaking
...
\\begin\{align}
P\_{\\bigtriangleup} &= P(0 < l_1, l_2, l_3 < \\frac\{1}\{2}) \\nonumber \\newline
...
so
\\begin\{align}
P\_{\\bigtriangleup} &= 1 - \\left(P(l_1 \\ge \\frac\{1}\{2}) + P(l_2 \\ge \\frac\{1}\{2}) + P(l_3 \\ge \\frac\{1}\{2})\\right) \\nonumber \\newline
...
\\begin\{equation}
\\int\_\{0}^{\\frac\{1}\{2}} \\int\_{\\frac\{1}\{2}}^{x_1+\\frac\{1}\{2}} 2, dx_2,dx_1\
= \\int\_\{0}^{\\frac\{1}\{2}} 2x_1 dx_1 = x_1^2|\_\{0}^{\\frac\{1}\{2}} = \\frac\{1}\{4}.
\\end\{equation}
...
$$X_2 | X_1  \sim U(X_1, 1).$\$
\\begin\{align}
P\_{\\bigtriangleup} &= \\int\_\{0}^{\\frac\{1}\{2}} \\frac\{1}\{1-x_1} \\int\_{\\frac\{1}\{2}}^{x_1+\\frac\{1}\{2}} dx_2, dx_1 \\nonumber \\newline\
&= \\int\_\{0}^{\\frac\{1}\{2}} \\frac\{x_1}\{1-x_1}dx_1 = log2 - \\frac\{1}\{2} \\approx 0.1931. \\nonumber
\\end\{align}
...
\\begin\{align}
P\_{\\bigtriangleup} &= \\int\_\{0}^{\\frac\{1}\{2}} \\int\_{\\frac\{1}\{2}-x_1}^{\\frac\{1}\{2}} \\frac\{1}{\\pi} x_2^{1/2}(1-x_1-x_2)^{1/2} dx_2, dx_1 \\nonumber \\newline
