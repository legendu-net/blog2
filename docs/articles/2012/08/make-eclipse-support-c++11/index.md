...
date: 2026-04-15 19:27:00.349958
authors:
  - bendu
...
1. Once created, right-click the project and go to "Properties"

1. C/C++ Build -> Settings -> Tool Settings -> GCC C++ Compiler -> Miscellaneous -> Other Flags.
   Put -std=c++0x at the end.

1. C++ General -> Paths and Symbols -> Symbols -> GNU C++.
...
1. Hit Apply, do whatever it asks you to do, then hit OK.
