...
date: 2026-04-15 19:27:01.456024
authors:
  - bendu
label: tips-on-outlook
license: CC-BY-4.0
tags:
  - software
  - Outlook
...
1. Message rules are very helpful for managing your emails.
   It is like "message filters" in Thunderbird.
   To create a message rule in Outlook 2007,

   1. Click the "Tools" menu.
   1. Click "Rules and Alerts...".
   1. Select the "Email Rules" Tab.
   1. Click "New Rule...".
   1. Choose a message rule template and follow the instructions.
   1. Do not forget to click "Apply" or "OK" after you are done!
      Otherwise, the message rule won't be saved.

1. To create a signature in Outlook 2007,

   1. Click the "Tools" menu.
   1. Click "Options".
   1. Select the "Mail Format" tab.
   1. Click "Signatures..." in the Signature group and follow the intructions.

1. You can use `Ctrl` + `Scroll` to zoom in/out an email message.

1. If you send an email to someone and like to send another follow-up before he/seh replies you,
...
1. outlook, need password problem
