...
date: 2026-04-15 19:27:01.431140
authors:
  - bendu
label: tips-on-teamdrive
license: CC-BY-4.0
tags:
  - software
  - TeamDrive
...
1. teamdrive on phone, if you use "available offline", update might not take effect ...
...
1. TeamDrive does not sync symbolic links currently!!

1. I don't TeamDrive support the standard hierarchical configuration files.

1. It seems that TeamDrive is slow when syncing database files.
...
1. Alternatively, you can import your own Space keys by choosing "Extras" --> "Settings" --> "Backup" --> "Import from Backups..." from the menu -->, provided you have previously saved these keys, select all backups --> "Open" --> select the backups and click "Import" --> afterwards, right click on the imported Spaces and select "Restore Space". Keys function only in conjunction with your username and are thus useless to other users.

1. You can always create an new Space sync it to the Cloud and share your files with others.
...
1. How to let TeamDrive show up in the notification aera in Ubuntu?

1. You can check in virtual machine to see whether a local config file works.
   Contact support first.

1. you should sync the filter files, let ... point to local ...

1. Check how you can link TeamDrive with Amazon S3 or use local disk

1. Teamview mess up file permissions!!!

1. how to change a space name on iPhone/computer?

1. how to ignore files/directories in TeamDrive?
