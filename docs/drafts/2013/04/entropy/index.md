...
date: 2026-04-13 23:33:12.076689
authors:
  - bendu
label: entropy
license: CC-BY-4.0
...
1. Shannon entropy is proven to be the lower bound of bits per symbol
...
1. Shanno entropy is equivalent to entropy in thermodynamics (an area of physics).

1. Entropy is a good metric to measure the magnitude of "information" in features/variables in machine learning.
   It can be used to filter out non-useful features/variables.

1. The entropy concept can be extended to continuous distributions.
   However,
...
1. For the reason in bullet point 4,
...
1. In a multi-class classification problem,
