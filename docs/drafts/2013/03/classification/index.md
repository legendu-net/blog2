...
date: 2026-04-13 23:33:12.975956
authors:
  - bendu
...
1. Do not forget the const/bias variable/feature.

1. Reguarization is critical

1. Python packages for classification often encode binary response variable as 0 and 1 (instead of -1 and 1).
