...
date: 2026-04-05 19:42:38.146568
authors:
- bendu
label: shortcuts-in-macos
license: CC-BY-4.0
tags:
- macOS
- Apple
...
and
`Alt + .` 
(so that they can be used by other applications, e.g., the fish shell)
,
you can add the following content into the file.
```
{
    "~e" = "noAction:";
    "~." = "noAction:";
