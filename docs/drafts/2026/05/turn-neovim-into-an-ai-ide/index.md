...
date: 2026-05-01 21:18:26.870751
authors:
  - bendu
...
2. Customize configuration (e.g., LLM provider) in 
...
4. If you run into errors saying "cannot make changes. modifiable is off" when using the sidebar,
